<template>
  <div dir="rtl" class="font-tajawal text-lg flex flex-col md:flex-row min-h-screen">
    <!-- Sidebar -->
    <!-- <Sidebar class="w-64 flex-shrink-0 md:flex-shrink-0" /> -->
    <div class="flex-1">
      <div class="flex flex-col md:flex-row min-h-screen font-cairo" dir="rtl">
        ...
        <div
          ...
          <div class="bg-[#E0AFFF] p-4 md:p-6 rounded text-center">
            <h1 class="text-2xl md:text-3xl font-bold text-white"> نظام ادارة الموظفين</h1>
          ...
          <div class="p-4 md:p-6 mx-auto">
            <div class="text-center my-6 bg-gray-100 p-4 rounded">
            ...
            <Modal v-if="showLeaveModal" @close="showLeaveModal = false">
              ...
              <template #body>
                <form @submit.prevent="submitLeave" class="grid gap-4 md:grid-cols-2">
                  <input v-model="form.employee" type="text" placeholder="اسم الموظف" class="border p-2 rounded" required />
                  ...
                  <textarea v-model="form.reason" placeholder="سبب الإجازة" class="border p-2 rounded md:col-span-2" required></textarea>
                  <button type="submit" class="bg-[#E0AFFF] text-white px-4 py-2 rounded hover:bg-[#795F8A] md:col-span-2">
                    إرسال الطلب
                  </button>
                </form>
              </template>
            ...
            <div class="overflow-x-auto">
              <table class="w-full table-auto border-collapse">
                <thead class="bg-gray-100">
                  <tr>
                    <th class="border px-2 md:px-4 py-1 md:py-2">#</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">الموظف</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">النوع</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">من - إلى</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">السبب</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">الحالة</th>
                    <th class="border px-2 md:px-4 py-1 md:py-2">الإجراء</th>
                  </tr>
                </thead>
                <tbody>
